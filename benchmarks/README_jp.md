...
検証では、同じ100問に対して「全文を渡す」条件が82%、「trikedbから50件を渡す」条件が86%でした。入力トークンの中央値は88.4%少なくなりました。この結果は、少ない入力でも同程度の回答率になったことを示します。条件と限界は[監査と再現性の記録](https://github.com/RyutoYoda/trikedb/blob/main/benchmarks/VALIDATION.md)にまとめています。
