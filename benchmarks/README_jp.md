...
| **ファイルとの比較** | 同じ事実を `CLAUDE.md` / `AGENTS.md` に置くと、同じ精度に対して1問あたり **78倍** のトークンがかかります |
...
| プロジェクトの事実数 | ナレッジファイル全文 | trikedb で | トークン |
|---|---|---|---|
| 492 | 9,668 tok · 82.0% | 409 tok · 77.0% | 24倍 |
| 1,181 | 22,153 tok · 72.0% | 397 tok · **73.0%** | 56倍 |
| 1,625 | 30,354 tok · 71.0% | 389 tok · **72.0%** | **78倍** |
