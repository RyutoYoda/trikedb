...
[WebQSP](https://aclanthology.org/P16-2033/) で測った3つの数字です。

| | |
|---|---|
| **精度** | 小さなローカルモデルが、trikedbのグラフを文脈にすると **42.7% → 77.7%** |
| **速度** | 1問22.5秒のうち、trikedbが使うのは **0.59秒** |
| **規模** | **10万トリプル**まで速い。最初に苦しくなるのは意味検索で、3万から |
