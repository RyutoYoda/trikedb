...
TEXT = {
    "en": {
        "title": "Measured operation time by graph size",
        "sub": "trikedb · one synthetic graph, six sizes · 3 repeats; HTML/search 1 warm sample",
        "x": "triples in the graph", "y": "milliseconds (log scale)",
        "open_json": "open a .json graph", "sparql_2hop": "SPARQL, 2-hop join",
        "open_yaml": "open the same graph as .yaml",
        "to_html": "generate the HTML workbench", "band_1s": "1 s", "band_10s": "10 s",
        "search": "semantic search()",
    },
    "jp": {
        "title": "グラフの規模と操作時間の実測値",
        "sub": "trikedb · 合成グラフ1つを6サイズ · 基本3回、HTML・検索はウォーム1回",
        "x": "グラフのトリプル数", "y": "ミリ秒（対数軸）",
        "open_json": ".json のグラフを開く", "sparql_2hop": "SPARQL 2ホップ結合",
        "open_yaml": "同じグラフを .yaml で開く",
        "to_html": "HTML ワークベンチを生成", "band_1s": "1 秒", "band_10s": "10 秒",
        "search": "意味検索 search()",
    },
    "zh": {
        "title": "不同图谱规模的操作时间",
        "sub": "trikedb · 一个合成图谱的六种规模 · 通常3次，HTML/检索预热后1次",
        "x": "图谱中的三元组数", "y": "毫秒（对数轴）",
        "open_json": "打开 .json 图谱", "sparql_2hop": "SPARQL 两跳连接",
        "open_yaml": "以 .yaml 打开同一个图谱",
        "to_html": "生成 HTML 工作台", "band_1s": "1 秒", "band_10s": "10 秒",
        "search": "语义检索 search()",
    },
}
